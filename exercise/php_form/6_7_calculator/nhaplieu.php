   ...
   <form name="calculator" action="./result.php" method="post">
      <table>
         ...
         <tr>
            ...
            <th>
               <input id="in" type="text" name="firstNum" placeholder="Nhập vào số thứ nhất..." required>
            </th>
         </tr>
         <tr>
            <th id="label">Số thứ hai:</th>
            <th>
               <input id="in" type="text" name="secondNum" placeholder="Nhập vào số thứ hai..." required>
            </th>
         </tr>
         <tr>
            <th></th>
