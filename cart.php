    ...
    <div class="col-md-8">    	
    		<ul class="list-group">    			
    			<li class="list-group-item" data-id="<?php echo $row['id'] ?>" data-price="<?php echo $row['price'] ?>">
    				<div class="d-flex w-100">
    					...
    					<div class="detail-field">
    						...
    						<div class="d-flex col-sm-5">
					            ...
					            <input type="number" name="qty" id="" class="form-control form-control-sm qty-input" value="">
    				...
    				<span class="float-right"><button class="btn btn-sm btn-outline-danger rem_item" type="button"  data-id=""><i class="fa fa-trash"></i></button></span>
    				</div>
    			</li>    		
    		</ul>    	
